...
robot = p.loadURDF("/home/stefan/Documents/Masterarbeit/rl_reach/code/gym_envs/widowx_env/envs/URDFs/ur_e_description/urdf/ur5e.urdf", useFixedBase=1,basePosition=[0,0,0.5])
box = p.loadURDF("/home/stefan/Documents/Masterarbeit/rl_reach/code/gym_envs/widowx_env/envs/URDFs/cube/cube_small.urdf", useFixedBase=1,basePosition=[0,0,0])
