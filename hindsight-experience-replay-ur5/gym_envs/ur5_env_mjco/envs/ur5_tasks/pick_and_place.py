...
class Ur5PickAndPlaceEnv(ur5_env.Ur5Env, utils.EzPickle):
    def __init__(self, reward_type='sparse'):
        ...
        rg2_initial_qpos = {
            ...
            "robot0:wrist_2_joint": 1.5797905921936035,
            "robot0:wrist_3_joint": -0.0025427977191370132,
            "left_moment_arm_joint": initial_gripper_spread,
            "right_moment_arm_joint": initial_gripper_spread,
            "l_finger_joint": initial_gripper_spread,
            "r_finger_joint": initial_gripper_spread
        }
