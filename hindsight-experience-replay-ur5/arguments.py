...
def get_args():
    ...
    parser.add_argument('--env-name', type=str, default='ur5_reach-v1', help='the environment name')
    parser.add_argument('--n-epochs', type=int, default=40, help='the number of epochs to train the agent')
