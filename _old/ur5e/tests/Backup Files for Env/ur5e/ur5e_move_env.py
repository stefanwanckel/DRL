...
class Ur5eEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.ur5eUid = p.loadURDF("ur5e_resources/ur_e_description/urdf/ur5e.urdf")
    ...
    def reset(self):
        ...
        self.objectUid = p.loadURDF("ur5e_resources/sphere_small/sphere_small.urdf",basePosition=state_object)
